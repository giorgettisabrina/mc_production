...
# with command line options: Configuration/GenProduction/python/ZpToQQ_fragment.py --python_filename ZpToQQ_m500_GENSIM_cfi.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:output_GENSIM.root --conditions 140X_mcRun3_2024_realistic_v26 --beamspot Realistic25ns13p6TeVEarly2023Collision --step GEN,SIM --geometry DB:Extended --era Run3_2024 --no_exec --mc -n 50000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/ZpToQQ_fragment.py nevts:50000'),
